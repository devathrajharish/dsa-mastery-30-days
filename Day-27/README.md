...
- Understand Choose → Explore → Undo
...
Generate all combinations, permutations, subsets, or possible configurations.
...
**Solution Location:** [solutions/1_subsets.py](solutions/1_subsets.py)
...
**Solution Location:** [solutions/2_permutations.py](solutions/2_permutations.py)
...
4. Move to [Day 28](../Day-28/README.md)
