...
Understand Recursive validation
...
Search efficiency or BST property validation.
...
**Solution Location:** [solutions/1_search_bst.py](solutions/1_search_bst.py)
...
**Solution Location:** [solutions/2_validate_bst.py](solutions/2_validate_bst.py)
...
4. Move to [Day 22](../Day-22/README.md)
